...
var Q7 = /*#__PURE__*/function (_React$Component) {
  _inherits(Q7, _React$Component);

  var _super = _createSuper(Q7);

  function Q7(props) {
    var _this;

    _classCallCheck(this, Q7);
  ...
  _createClass(Q7, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('/api/q7').then(function (response) {
        return response.json();
      }).then(function (result) {
        console.log(result);
